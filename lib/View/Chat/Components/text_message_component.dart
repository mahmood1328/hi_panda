...
class TextMessageComponent extends StatelessWidget {
  ...
  const TextMessageComponent({Key? key,required this.isMyMessage,required this.isColleagueMessage,required this.message}) : super(key: key);
      ...
      ChatBubble(
        ...
        child: Container(
          ...
          child:  Column(
            ...
            children: [
              SelectableText(message.message , style:
