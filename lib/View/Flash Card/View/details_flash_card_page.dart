  ...
  Widget build(BuildContext context) {
    return  GetX<FlashCardController>(
        ...
        builder: (flashCardController) {
          return flashCardController.loadingBox.value
              ? Scaffold(
                                              ...
                                              children: <Widget>[
                                                ...
                                                Obx(() => Padding(
                                                  ...
                                                  child: Row(
                                                    ...
                                                    const Text("ارسال به صورت گروهی برای همه",style:
                                                    TextStyle(color: ColorsApp.primaryLight2,fontSize: 13,fontFamily: "IranSANS",fontWeight: FontWeight.bold),),

                                                      GestureDetector(
                                                        onTap: (){
                                                          flashCardController.getChecking();
                                                        },
                                                        child: Icon( flashCardController.isCheck.value?Icons.check_box: Icons.check_box_outline_blank,color: ColorsApp.primaryLight2,
                                                          size: 27,
                                                        ),
                                                      )
                                                    ],
                                                ...
                                                Row(
                                                  children: [
                                                    ...
                                                    Expanded(
                                                      child: Padding(
                                                        padding: const EdgeInsets.only(left: 20,right: 40,top: 10,bottom: 5),
                                                        child: TextFormField(
                                                      ...
                                                      onPressed: () {
                                                        ...
                                                        if(flashCardController.title2Controller.text!=""&&flashCardController.textController.text!=""){
                                                          flashCardController.addItemToFlashCard(id, flashCardController.title2Controller.text,
                                                              flashCardController.textController.text, flashCardController.fileId.value.toString(), flashCardController.senseController.text, context,true);
                                                        }
