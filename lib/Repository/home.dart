...
class HomeRepository {
  ...
  Future<GetBookAndPdfDetailModel> getMyCoursesDetailBookAndPdf(int id,int pId,int type) async{

    final resources = await _helper.post(ServiceURL.getBookAndPDFDetail,auth: true,data: {"id":id,"pId":pId,"type":type});
    return  GetBookAndPdfDetailModel.fromJson(resources);
  }
